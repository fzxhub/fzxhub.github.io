---
title: Hexo博客主题hexo-theme-matery使用
date: 2018-09-28 13:34:00
author: fzxhub
cover: true
categories: website
summary: 这是一个采用`Material Design`和响应式设计的 Hexo 博客主题。简单漂亮，文章内容美观易读，响应式设计，博客在桌面端、平板、手机等设备上均能很好的展现。
tags:
  - Hexo
  - hexo-theme-matery
---
转载自[blinkfox](https://github.com/blinkfox)
[演示示例](https://blinkfox.github.io/) | QQ交流群:`926552981`
