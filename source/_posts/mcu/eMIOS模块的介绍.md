...
author: fzxhub
cover: true
img: https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/CB.png
...
![模块](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/BD.png)
...
![模块](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/CB.png)
...
![通道](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/UC.png)
...
![SAIC](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/SAIC.png)
![SAICB](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/SAICB.png)

## eMIOS SAOC模式

Single Action Output Capture  Mode就是输出匹配模式。给AS2写入一个值后，当Counter Bus的值与AS2相等时，这个时候就会产生一个Flag信号，同时控制输出跳变或者翻转。

![SAOC](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/SAOC.png)
![SAOCT](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/SAOCT.png)
...
![IPWM](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/IPWM.png)
...
![IPM](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/IPM.png)
...
![DAOC](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/DAOC.png)
...
![PEC](https://cdn.jsdelivr.net/gh/fzxhub/image_bed@main/emios/PEC.png)
