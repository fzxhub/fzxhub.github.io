...
## 实物展示
![avatar](/images/links2.jpg)

![avatar](/images/links1.jpg)

![avatar](/images/links3.jpg)

## 底板3D图
![avatar](/images/link4.png)
...
### **2.54间距接口图**
![avatar](/images/link5.png)
## 固件切换
1. 使用自己的STLINK与link_debuger的5.0V、SWD、SCK、GND连接。
2. 打开STM32 ST-LINK Utility
3. 连接设备
![avatar](/images/prog1.png)
4. 打开文件
![avatar](/images/prog2.png)
5. 选择固件（DAP选择bootloader）
![avatar](/images/prog3.png)
6. 开始编程
![avatar](/images/prog4.png)
7. 点击start、等待进度条完成后即可使用
![avatar](/images/prog5.png)
![avatar](/images/prog6.png)
